...
const [arr, setArr]= useState([
    ...
    {name:"plants1",src:"https://besthqwallpapers.com/Uploads/31-3-2018/46606/thumb2-jupiter-4k-planets-galaxy-nebula.jpg",isSucssed: true,id:3},
    ...
    {name:"plants1",src:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0XY3U8y_IczhRKEoelQzlfvHuCHBXg0B3ty6g-UQV7lKlIh4SzPa8Rd_d3kIqTZ3WeCw&usqp=CAU",isSucssed: true,id:5},
    ...
    return (
        <div className="grand">
            ...
            <div className= "gameBox">
                ...
                {arr.map((elem,i)=>
                <img src={elem.src} key={i+2} className={elem.isSucssed ? `hideImg` : `showImg`}/>
